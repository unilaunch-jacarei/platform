...
def upgrade() -> None:
    if op.get_context().dialect.name == "sqlite":
        ...
        op.create_check_constraint("ck_leads_privacy_consent", "leads", "privacy_consent = true")
...
def downgrade() -> None:
    if op.get_context().dialect.name == "sqlite":
        ...
        op.drop_constraint("ck_leads_privacy_consent", "leads", type_="check")
        op.drop_constraint("ck_leads_status", "leads", type_="check")
        op.drop_constraint("ck_leads_company_size", "leads", type_="check")
